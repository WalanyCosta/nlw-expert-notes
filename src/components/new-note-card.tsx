          ...
          <form className='flex-1 flex flex-col'>
            <div className="flex flex-1 flex-col gap-3 p-5">
                ...
                {shouldShowOnboarding ? (
                  ...
                  Comece <button type='button' onClick={handleStartRecording} className='text-lime-400 hover:underline'>gravando uma nota</button> em  áudio ou se preferir <button type='button' className='text-lime-400 hover:underline' onClick={handleStartEditor}>utilize apenas texto</button>.
                </p>
                ):(
                  <textarea
                    value={content}
